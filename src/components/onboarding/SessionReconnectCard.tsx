...
export const SessionReconnectCard: React.FC<SessionReconnectCardProps> = ({
  ...
  return (
    ...
    >
      <div className="rounded-2xl bg-slate-900/90 border border-emerald-500/40 p-6 sm:p-8 shadow-2xl shadow-emerald-950/40 relative overflow-hidden backdrop-blur-md">
        ...
        <div className="mb-6 relative z-10">
          <p className="text-sm text-slate-200">
            ...
            {userEmail && (
              <span className="font-mono text-emerald-400 ml-1.5 font-medium">
                ({userEmail})
              </span>
            )}
          </p>
        ...
        <div className="rounded-xl bg-slate-950/80 border border-slate-800 p-4 mb-6 space-y-3 relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
            <div className="flex items-start space-x-2 bg-slate-900/80 p-2.5 rounded-lg border border-slate-800/80">
              <Building2 className="w-4 h-4 text-slate-400 mt-0.5 shrink-0" />
              <div className="min-w-0">
                <div className="text-[10px] text-slate-500 uppercase font-semibold">Billed GCP Project</div>
                <div className="font-mono text-slate-200 truncate font-medium">
            ...
            <div className="flex items-start space-x-2 bg-slate-900/80 p-2.5 rounded-lg border border-slate-800/80">
              ...
              <div className="min-w-0">
                ...
                <div className="font-mono text-emerald-300 truncate font-medium">
        ...
        {errorMessage && (
          <div className="mb-6 p-3.5 rounded-xl bg-amber-950/40 border border-amber-500/30 text-amber-200 text-xs flex items-start space-x-2.5 relative z-10">
            <AlertCircle className="w-4 h-4 text-amber-400 mt-0.5 shrink-0" />
            <div>
              <span className="font-semibold">Interactive Re-Authentication Required: </span>
              <span className="text-amber-300/90">{errorMessage}</span>
            </div>
          </div>
        )}
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3 pt-2 relative z-10">
          ...
          <button
            ...
            className="w-full sm:w-auto py-3 px-4 rounded-xl bg-slate-800 hover:bg-slate-700 disabled:opacity-50 text-slate-300 font-semibold text-xs flex items-center justify-center space-x-1.5 transition-all border border-slate-700 cursor-pointer"
          >
