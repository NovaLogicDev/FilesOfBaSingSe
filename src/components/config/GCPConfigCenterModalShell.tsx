...
export const GCPConfigCenterModalShell: React.FC<GCPConfigCenterModalShellProps> = ({
  ...
  return (
    ...
    >
      <div className="w-full max-w-4xl max-h-[90vh] bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-2xl shadow-slate-300/50 dark:shadow-slate-950 flex flex-col overflow-hidden text-slate-900 dark:text-slate-100 transition-colors">
        {/* Header */}
        <div className="px-6 py-4 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between bg-slate-50 dark:bg-slate-950/60">
          <div className="flex items-center space-x-2.5">
            <div className="w-8 h-8 rounded-lg bg-emerald-100 dark:bg-emerald-500/10 border border-emerald-300 dark:border-emerald-500/30 flex items-center justify-center text-emerald-700 dark:text-emerald-400">
              <ShieldCheck className="w-5 h-5" />
            </div>
            <div>
              <h2 id="gcp-config-title" className="text-base font-bold text-slate-900 dark:text-white tracking-tight">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800 space-y-3">
              <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800/80 pb-2">
                ...
                {oauthToken ? (
                  <span className="px-2 py-0.5 rounded-full text-[10px] font-semibold bg-emerald-100 dark:bg-emerald-500/20 text-emerald-800 dark:text-emerald-300 border border-emerald-300 dark:border-emerald-500/30">
                    Authenticated
                  </span>
                ) : (
                  <span className="px-2 py-0.5 rounded-full text-[10px] font-semibold bg-rose-100 dark:bg-rose-500/20 text-rose-800 dark:text-rose-300 border border-rose-300 dark:border-rose-500/30">
                    Unauthenticated
                  </span>
                )}
              </div>
              ...
              <div className="flex items-center space-x-3">
                {userAvatar ? (
                  ...
                  <div className="w-10 h-10 rounded-full bg-slate-200 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 flex items-center justify-center text-slate-600 dark:text-slate-300">
              ...
              <div className="space-y-1 text-xs text-slate-700 dark:text-slate-300 font-mono pt-1">
            ...
            <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800 space-y-3">
              ...
              <div className="space-y-2">
                <div>
                  ...
                  <div className="font-mono text-sm font-bold text-emerald-700 dark:text-emerald-300">{displayProject}</div>
                </div>
                ...
                <div className="pt-1 flex items-center space-x-2">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center space-x-1 text-xs text-cyan-600 dark:text-cyan-400 hover:text-cyan-700 dark:hover:text-cyan-300 transition-colors"
                  >
            ...
            <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800 space-y-3">
              ...
              <div className="space-y-1.5">
                <div>
                  ...
                  <div className="font-mono text-xs font-bold text-slate-900 dark:text-white truncate">{displayBucket}</div>
                </div>

                <div className="flex items-center justify-between text-xs font-mono pt-1">
                  <span className="text-slate-500">Recent Buckets:</span>
                  <span className="text-slate-700 dark:text-slate-300">{recentBuckets.length} saved</span>
                </div>

                <div className="flex items-center justify-between text-xs font-mono">
                  <span className="text-slate-500">CORS Headers:</span>
                  <span className="text-emerald-700 dark:text-emerald-400 font-semibold">x-goog-hash, Content-Length</span>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800 space-y-3">
              <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800/80 pb-2">
                ...
                <button
                  ...
                  className="text-xs text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 dark:hover:text-emerald-300 font-semibold cursor-pointer underline underline-offset-2"
                >
                  Edit Rates
                </button>
              </div>
              ...
              {isFreeTrialAccount && (
                <div className="p-2 rounded-lg bg-indigo-50 dark:bg-indigo-950/40 border border-indigo-200 dark:border-indigo-500/30 flex items-center space-x-2 text-xs text-indigo-800 dark:text-indigo-300 font-mono">
          ...
          <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950/80 p-4 space-y-3">
            <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-2.5">
              ...
              <button
                ...
                className="px-3 py-1 rounded-lg bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 border border-slate-200 dark:border-slate-700 text-xs font-semibold text-cyan-700 dark:text-cyan-300 flex items-center space-x-1.5 cursor-pointer disabled:opacity-50"
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2.5">
              {/* Check 1 */}
              <div className="p-3 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/60 flex items-start space-x-2.5">
                ...
                <div>
                  <div className="text-xs font-semibold text-slate-900 dark:text-white">1. OAuth 2.0 Token</div>
              ...
              <div className="p-3 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/60 flex items-start space-x-2.5">
                ...
                <div>
                  <div className="text-xs font-semibold text-slate-900 dark:text-white">2. Requester-Pays</div>
                  <div className="text-[11px] text-slate-500 dark:text-slate-400 font-mono">
              ...
              <div className="p-3 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/60 flex items-start space-x-2.5">
                ...
                <div>
                  <div className="text-xs font-semibold text-slate-900 dark:text-white">3. IAM ObjectViewer</div>
                  <div className="text-[11px] text-slate-500 dark:text-slate-400 font-mono">
              ...
              <div className="p-3 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/60 flex items-start space-x-2.5">
                ...
                <div>
                  <div className="text-xs font-semibold text-slate-900 dark:text-white">4. CORS Headers</div>
                  <div className="text-[11px] text-slate-500 dark:text-slate-400 font-mono">
          ...
          <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950/60 p-4 space-y-3">
            <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800/80 pb-2">
              ...
              <span className="px-2 py-0.5 rounded-full text-[10px] font-semibold bg-cyan-100 dark:bg-cyan-500/20 text-cyan-800 dark:text-cyan-300 border border-cyan-300 dark:border-cyan-500/30">
                Module 12
              </span>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 pt-1">
              <button
                ...
                className={`p-3 rounded-xl border text-left transition-all cursor-pointer ${
                  preferredDownloadStrategy === 'service_worker' || !preferredDownloadStrategy
                    ? 'border-purple-300 dark:border-purple-500/60 bg-purple-50 dark:bg-purple-950/20 text-slate-900 dark:text-white'
              ...
              >
                <div className="flex items-center justify-between mb-1">
                  <span className="font-bold text-xs text-purple-700 dark:text-purple-300">Chrome Download Manager</span>
                  {(preferredDownloadStrategy === 'service_worker' || !preferredDownloadStrategy) && (
                    <span className="text-[10px] font-mono text-purple-600 dark:text-purple-400 font-bold">[Active Default]</span>
                  )}
                </div>
                <p className="text-[11px] text-slate-500 dark:text-slate-400 leading-normal">
                  Streams direct to your browser&apos;s download manager (<code className="font-mono text-slate-700 dark:text-slate-300">chrome://downloads</code>) with native &quot;Show in folder&quot; without annoying file picker dialogs.
                </p>
              </button>
              ...
              <button
                ...
                className={`p-3 rounded-xl border text-left transition-all cursor-pointer ${
                  preferredDownloadStrategy === 'fsaa'
                    ? 'border-emerald-300 dark:border-emerald-500/60 bg-emerald-50 dark:bg-emerald-950/20 text-slate-900 dark:text-white'
                    : 'border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/40 text-slate-600 dark:text-slate-400 hover:border-slate-300 dark:hover:border-slate-700'
                }`}
              >
                <div className="flex items-center justify-between mb-1">
                  <span className="font-bold text-xs text-emerald-700 dark:text-emerald-300">Direct to Disk (FSAA)</span>
                  {preferredDownloadStrategy === 'fsaa' && (
        ...
        {/* Footer Actions */}
        <div className="px-6 py-4 border-t border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950/80 flex flex-col sm:flex-row items-center justify-between gap-3 transition-colors">
          <div className="flex items-center space-x-2">
            <button
              type="button"
              onClick={handleExportDiagnostics}
              className="px-3.5 py-2 rounded-xl bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 border border-slate-200 dark:border-slate-700 text-cyan-700 dark:text-cyan-300 text-xs font-semibold flex items-center space-x-1.5 transition-all cursor-pointer"
            >
          ...
          <div className="flex items-center space-x-3">
            ...
            <button
              type="button"
              onClick={onClose}
              className="px-5 py-2 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-slate-950 text-xs font-bold transition-all shadow-md shadow-emerald-500/10 dark:shadow-emerald-950/40 cursor-pointer"
            >
              Done
            </button>
          </div>
