  ...
  ({
    ...
    return (
      <div
        ...
        className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/40 overflow-hidden shadow-xl shadow-slate-200/50 dark:shadow-none focus:outline-none focus:ring-1 focus:ring-emerald-500/50 transition-colors"
      >
        <div className="overflow-x-auto">
          {/* Header Row */}
          <div
            role="rowgroup"
            className="border-b border-slate-200 dark:border-slate-800 bg-slate-100/90 dark:bg-slate-900/90 text-slate-600 dark:text-slate-400 font-semibold select-none min-w-[800px]"
          >
            <div
              role="row"
              aria-rowindex={1}
            ...
            >
              ...
              >
                <div className="flex items-center space-x-1.5">
                  <span>Name</span>
                  <ArrowUpDown
                    className={`w-3 h-3 ${sortColumn === 'name' ? 'text-emerald-600 dark:text-emerald-400 opacity-100' : 'opacity-60'}`}
                  />
                </div>
              </div>
              ...
              <div
                ...
                className="cursor-pointer hover:text-slate-900 dark:hover:text-white transition-colors px-1"
              >
                <div className="flex items-center space-x-1.5">
                  <span>Storage Class</span>
                  <ArrowUpDown
                    className={`w-3 h-3 ${sortColumn === 'class' ? 'text-emerald-600 dark:text-emerald-400 opacity-100' : 'opacity-60'}`}
                  />
                </div>
              </div>
              ...
              >
                <div className="flex items-center space-x-1.5">
                  <span>Size</span>
                  <ArrowUpDown
                    className={`w-3 h-3 ${sortColumn === 'size' ? 'text-emerald-600 dark:text-emerald-400 opacity-100' : 'opacity-60'}`}
                  />
                </div>
              </div>
              ...
              <div
                ...
                className="cursor-pointer hover:text-slate-900 dark:hover:text-white transition-colors px-1 hidden md:block"
              >
                <div className="flex items-center space-x-1.5">
                  <span>Last Modified</span>
                  <ArrowUpDown
                    className={`w-3 h-3 ${sortColumn === 'updated' ? 'text-emerald-600 dark:text-emerald-400 opacity-100' : 'opacity-60'}`}
                  />
                </div>
              </div>
          ...
          >
            {totalCount === 0 ? (
              <div className="py-16 flex flex-col items-center justify-center space-y-3 text-slate-500 dark:text-slate-400">
                <div className="p-3 rounded-full bg-slate-100 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700/60 text-slate-400 dark:text-slate-500">
                  <Inbox className="w-6 h-6" />
                </div>
                <p className="text-sm font-medium text-slate-700 dark:text-slate-300">No media files found matching your criteria.</p>
        ...
        {/* Table Footer */}
        <div className="p-3 border-t border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/80 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-slate-600 dark:text-slate-400 transition-colors">
          <div className="flex items-center space-x-3">
            ...
            {nextPageToken && onLoadNextPage && (
              <button
                ...
                className="px-2.5 py-1 rounded-lg bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-700 dark:bg-emerald-500/20 dark:hover:bg-emerald-500/30 dark:text-emerald-300 border border-emerald-500/30 dark:border-emerald-500/40 text-xs font-semibold flex items-center space-x-1.5 cursor-pointer transition-colors"
              >
